...
/* not sure if this should be used in 1.8, possible combined into this file */
#ifndef	NEW_ASTERISK
...
/* same here, if the .h sound files are included, then this needs to be included as well */
#ifndef	NEW_ASTERISK
...
struct chan_usbradio_pvt {
	...
	char *name;
/* this was commented out so it would be included, since index is used even if NEW_ASTERISK 
isn't defined elsewhere in the code */
...
/* will be needed if code referencing it is included */
#ifndef	NEW_ASTERISK
	.cursound = -1,
#endif
	.sounddev = -1,
...
/* not sure if we need this with a newer version of asterisk */
#ifndef	NEW_ASTERISK
...
{
	/* will be needed if sound routines are included */
#ifndef	NEW_ASTERISK
...
static int usbradio_answer(struct ast_channel *c)
{
	/* code here and below will be needed if sounds routines are included */
#ifndef	NEW_ASTERISK
	struct chan_usbradio_pvt *o = c->tech_pvt;
#endif
...
static int usbradio_hangup(struct ast_channel *c)
{
	...
	/* needed if sound routines are included */
#ifndef	NEW_ASTERISK
	o->cursound = -1;
	o->nosound = 0;
#endif
